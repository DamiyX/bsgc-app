...
void main() {
  test(
    'profile mutations use explicit queued and retry copy when offline',
    () {
  ...
  test('commit acknowledgement completes only after pending writes clear', () async {
  ...
  test('commit acknowledgement times out while a write stays pending', () async {
    await expectLater(
